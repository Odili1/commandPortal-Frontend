  ...
  return (
    <>
      <div className="">
        ...
        <div className="pt-[80px] md:g rid md:gri d-cols-5 md:flex w-full min-h-[100vh]">
          <div className="hidden h -[100vh] overflow -y-scroll md:block md:w-[20%] md :relative">
            <Sidebar />
          </div>
          <div className="bg-slate-100 pt-8 pb-5 min-h-[60vh] md:pt-12 md:col -start-2 md:co l-end-6 md:w-[80%] overflow -y-scroll">
            {/* Main */}
            <Outlet/>
