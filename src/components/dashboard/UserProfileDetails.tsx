        ...
        userData ? (
          <>
            <div className="relative">
              ...
              <div
                className="absolute top-[0%] right-[10%] md:top-[5%] md:right-[5%]"
                ref={optionRef}
              >
                <button
                  className={`text-darkerTrans ${role === 'student' ? 'cursor-not-allowed' : ''}`}
            ...
            <div className="Name_and_class px-10">
              ...
              <p className="text-center text-xl">{`${idToRole(
                ...
                ?.slice(0, 1)
                .toUpperCase()}${idToRole(userData?.userId || "")?.slice(
                1
              )}`}</p>
            </div>
