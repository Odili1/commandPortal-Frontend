...
const DashboardHeader = () => {
  ...
  const [userData, setUserData] = useState<{lastName?: string, avatar?: string} | null>(null)
          ...
          <div className="flex items-center justify-between py-6 mx-4 md:mx-2">
            <div className="flex items-center">
              ...
              <Link to={'/st/dashboard'} className="flex items-center mr-2">
                <img src={logo} alt="Logo" className='w-auto h-9 md:h-9 rounded-md md:rounded-xl' />
            ...
            <div className="">
              <div className="flex items-center md:justify-between">
                <p className="hidden text-darkerTrans text-xl font-medium mr-10 md:block">Hi, {userData?.lastName}</p>
                ...
                <button>   
                  {!userData?.avatar 
                    ? <div className="flex justify-center items-center h-10 w-10 mx -auto bg-slate-200 rounded-full"><FaUser color="gray" fontSize={'22px'} className=""/></div>
                    : <img src={userData?.avatar} className='h-8 w-8 md:h-10 md:w-10 rounded-full'/>
                  }      
                </button>
              </div>
            </div>
