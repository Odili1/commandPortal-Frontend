...
const Hero = () => {
  return (
    <div className="bg-blue-600 min-h-[95vh] w-[100]">
        <div className="conatiner max-w-7xl mx-auto flex flex-col pt-40 md:flex-row md:justify-between md:items-center">
            <div className='text-left flex flex-col mb-24 justify-between items-left px-5 md:mb-0 md:w-[55%] md:text-left'>
                <h1 className="text-white text-2xl font-bold md:text-5xl leading-tight">Welcome to Command Children School, Calabar Portal</h1>
