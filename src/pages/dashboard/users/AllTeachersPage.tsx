        ...
        <div className="contaier flex flex-wrap items -center justify-between gap-x-8 mb -8">
          ...
          <div className="flex justify-between gap-x-14 mt-7 md:mt-0">
            ...
            <div className="w-[55%] md:w-[33%]">
              <Link to={'/teacher/create-new-teacher'} className="p-3 bg-green-700 flex items-center gap-x-2 rounded-2xl text-xs md:text-lg font-semibold text-gray-200 transition-colors delay-75 duration-300 hover:bg-green-900">
