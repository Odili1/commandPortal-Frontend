...
type useLoadUserReturnType = () => Promise<{lastName: string, avatar: string} | null>

export const useLoadUser = (): useLoadUserReturnType => {
    ...
    }, [role, fetchAdmin, dispatch, userId, fetchStudent])
